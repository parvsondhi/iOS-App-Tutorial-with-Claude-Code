...
Send this prompt to Claude Code to generate the skeleton component, then check the reference below:
...
Send this prompt to Claude Code to generate the empty state component, then check the reference below:
...
Send this prompt to Claude Code to generate the toast system, then check the reference below:
...
Send this prompt to Claude Code to generate the onboarding screen, then check the reference below:
...
Send this prompt to Claude Code to generate the relative time function, then check the reference below:
