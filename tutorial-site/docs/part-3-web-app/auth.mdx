...
The auth hook manages the current user state and exposes login/signup/logout functions:
...
Create a combined login/signup screen:
...
Replace the placeholder Profile page with user info and logout:
...
Now connect everything at the top level:
