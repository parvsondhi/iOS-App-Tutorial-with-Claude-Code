...
<TroubleshootingAccordion items={[
  ...
  },
  {
    ...
    solution: <p>App IDs are globally unique. Add a distinguishing element: <code>com.yourname.gratitudetree-app</code> or use your actual domain if you have one. Update the Bundle ID in both Xcode and <code>capacitor.config.ts</code>.</p>
  }
]} />
