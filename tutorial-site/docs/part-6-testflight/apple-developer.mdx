---
sidebar_position: 1
title: "Chapter 13: Apple Developer Account"
...
# Chapter 13: Apple Developer Account
...
**No.** Xcode's **Automatic Signing** handles certificate creation for you. When you enable automatic signing (which we did in Chapter 9), Xcode:
...
Your Bundle ID is the unique identifier for your app. We set this in Chapter 9:
...
<ClaudeCodePrompt
  prompt="I'm setting up my Apple Developer account for the first time and I see a lot of unfamiliar terms in Xcode — certificates, provisioning profiles, entitlements, capabilities. Can you explain what I actually need to worry about vs. what Xcode handles automatically?"
...
**[Next: Chapter 14 — App Store Connect Setup →](./app-store-connect)**
