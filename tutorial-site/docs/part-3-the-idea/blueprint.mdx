...
<ClaudeCodePrompt
  variant="build"
  step="Step 1"
  prompt="I want to build a journal app called GratitudeTree. It should support text entries, photo entries, and a shake-to-discover feature. Help me scope the MVP — what features should be in v1 vs cut for later? Dont code anything yet and output your plan in a new implementation.md file"
