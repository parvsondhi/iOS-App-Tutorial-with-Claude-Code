...
> Time to build the core of GratitudeJar. By the end of this chapter, users can create entries, see them in a feed, edit, delete, and upload photos — all persisted in Firebase.
