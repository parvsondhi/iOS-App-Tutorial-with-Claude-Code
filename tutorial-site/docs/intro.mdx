...
Everything else (Node.js, Xcode, a code editor) gets installed in Chapter 1.
...
|---|---|---|
| **Part 1 — Getting Started** | 1 | Install tools: Node.js, Claude Code, editor, Xcode |
| **Part 2 — The Idea** | 2 | Blueprint: scope, wireframes, data model |
| **Part 3 — Foundation** | 3 | Project scaffolding + dependencies |
| **Part 4 — Web App** | 4–10 | Full web app: UI, CRUD, Firebase, auth, polish |
| **Part 5 — Going Mobile** | 11–14 | Capacitor, camera, shake, iOS polish — **your app in the Simulator!** |
| **Part 6 — TestFlight** *(optional)* | 15–17 | Apple Developer, App Store Connect, TestFlight |
| **Part 7 — Next Steps** | 18–19 | Iteration cycle + App Store submission |
...
**[Start Chapter 1: Setting Up Your Tools →](./part-1-getting-started/tools-setup)**
